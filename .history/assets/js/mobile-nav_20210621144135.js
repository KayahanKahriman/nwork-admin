...
const mobile_nav_parent_ul = mobile_nav.querySelectorAll("#mobile-nav>ul>ul");
...
console.log(mobile_nav_parent_li_a);

Array.from(mobile_nav_parent_li_a).map((e) =>
  e.addEventListener("touchstart", function () {
    Array.from(mobile_nav_parent_ul).map((ul) => (ul.style.display = "none"));
    console.log((e.nextElementSibling.style.display = "block"));
  })
);
